...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="span10" id="content">
            ...
            <div class="well">
                <form id="search" action="${pageContext.request.contextPath}/user/feedback/list/1" method="post">
                    <input type="hidden" id="size" name="size" value="${size}" />
                    <div class="input-group pull-left">
                        <span>联系方式</span>
                        <input class="horizontal marginTop" id="contact" name="contact" type="text" value="${contact}" />
                        <span>意见反馈:</span>
                        <input class="horizontal marginTop" id="contents" name="content" type="text"  value="${content}" />
                        <%-- <span>时间:</span>
                        <input id="beginTime" class="datepicker marginTop" readonly style="background:white;" name="beginTime" type="text" value="${beginTime}" />
                        -
                        <input class="datepicker marginTop" id="endTime" readonly style="background:white;" name="endTime" type="text" value="${endTime}" />
--%>
                        <span >时间:</span>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.breadcrumb').html('<li class="active">内容管理&nbsp;/&nbsp;客户意见反馈</li>');
        if(totalPages > 0) {
            var options = {
                currentPage: '${page}',
                ...
                onPageClicked: function(event, originalEvent, type, page){
                    $('#search').attr('action','${pageContext.request.contextPath}/user/feedback/list/'+page);
                    $('#search').submit();
                }
            };
    ...
    function resetData() {
        ...
        $('#beginTime').val('');
        $('#endTime').val('');
        $('#search').attr('action','${pageContext.request.contextPath}/user/feedback/list/1');
        $('#search').submit();
    }
</script>
</html>