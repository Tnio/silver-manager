            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <form class="form-horizontal" style="margin-bottom: 0;" enctype="multipart/form-data" id="fm" method="post" onsubmit="return startValidate();" action="${pageContext.request.contextPath}/banner/notice/save">
                            <div class="well" style="padding-bottom: 20px; margin: 0;">
                                <input id="id" name="id" value="${image.id }" type="hidden">
                                <input name="category" value="${image.category }" type="hidden">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if('${operation}' == 'edit'){
            $('.breadcrumb').html('<li class="active"><li class="active">图片管理&nbsp;/&nbsp;<a href="javascript:quit();">弹窗公告管理&nbsp;</a>/&nbsp;编辑</li>');
            $('#save').show();
        }else{
            $('.breadcrumb').html('<li class="active"><li class="active">图片管理&nbsp;/&nbsp;<a href="javascript:quit();">弹窗公告管理&nbsp;</a>/&nbsp;查看</li>');
            $('#save').hide();
            readOnly();
        }
    ...
    function quit() {
        window.location.href='${pageContext.request.contextPath}/banner/list/1/7';
    }
    ...
    function reUpload() {
        ...
        if (confirm(msg)==true){
            ...
            $.post('${pageContext.request.contextPath}/client/merchant/loan/contract/delete', {'name' : name}, function(result){
                ...
                document.getElementById('bigImage').innerHTML = '<input id="urls" type="file" name="urls" accept="image/jpeg, image/png" onchange="selectFile();" /><span><font style="color:red;">（APP弹窗图建议尺寸：575*755；WEB弹窗图建议尺寸：745*710，png或者jpg格式）</font></span>';
            });
        }
    }
