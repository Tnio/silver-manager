                ...
                <form class="form-horizontal" enctype="multipart/form-data" id="fm" method="post" onsubmit="return startValidate();" action="${pageContext.request.contextPath}/app/image/save">
                    ...
                    <div class="well" style="padding-bottom: 20px; margin: 0;">
                        <div class="control-group">
                            ...
                            <div class="controls"><input type="text" id="title" name="name" value="vip专属加息" readonly="readonly" ></div>
                        </div>
                        <div class="control-group">
                            <label class="control-label"><span class="required">*</span> 图片</label>
                            <div class="controls" id="imgReUpload"><img id="imgUrl" style="width:140px;height:140px;" src="" alt="图片可能丢失" /></div>
                        </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('#imgUrl').attr('src', url);
        if('${operation}' == 'edit'){
            $('.breadcrumb').html('<li class="active">图片管理&nbsp;/&nbsp;<a href="javascript:quit();">APP图片管理</a>&nbsp;/&nbsp;vip专属加息图</li>');
            $('#save').show();
        }else{
            $('.breadcrumb').html('<li class="active">图片管理&nbsp;/&nbsp;<a href="javascript:quit();">APP图片管理</a>&nbsp;/&nbsp;vip专属加息图</li>');
            $('#save').hide();
    ...
    function reUpload(value) {
        ...
        load++;
        $('#'+value).html('');
        $('#'+value).html('<img id="preview_imgUrl" /><input id="imgUrl" type="file" name="imgUrl" accept="image/*" onchange="javascript:setImagePreview(this.id);" /><span><font style="color:red">（建议尺寸：140*140，支持png或jpg格式）</font></span>');
    }
