...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
        <div class="container-fluid">
            ...
            <span class="brand">银狐科技</span>
            <div class="nav-collapse collapse">
                <ul class="nav pull-right">
                    <li class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> 
                        	<i class="icon-user"></i>欢迎您： ${sessionsilverfoxkey.admin.realName}<i class="caret"></i>
                        </a>
                ...
                <ul class="nav" >
					<c:choose>
						 <c:when test="${sessionsilverfoxkey != null}">
							<c:if test="${sessionsilverfoxkey.menu != null}">
								<c:forEach items="${sessionsilverfoxkey.menu }" var="entry" varStatus="s">
