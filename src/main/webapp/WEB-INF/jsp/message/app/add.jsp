...
<html>
	                        ...
	                        <form id="fm" action="${pageContext.request.contextPath}/message/app/save" method="post" class="form-horizontal" onsubmit="return validate()" >
								 <div class="well" style="padding-bottom: 20px; margin: 0;">
									<div class="control-group">
										...
										<input id="id" name="type" value="5" type="hidden">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="news_content" class="text-input span8" readonly onclick="showNewsDialog()"/>
											<button type="button" class="btn btn-icon btn-default" onclick="preview()">预览</button>
											<input type="hidden" id="contentId" name="news.id" value="0">	
										</div>
									</div>
	...
	<script type="text/javascript">
		$(function(){
			$('.breadcrumb').html('<li class="active">消息管理&nbsp;/&nbsp;<a href="javascript:quit();">APP消息管理</a>&nbsp;/&nbsp;新增APP消息</li>');
