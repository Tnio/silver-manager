...
<html>
	...
	<body>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
	                             <form id="fm" action="${pageContext.request.contextPath}/message/save" method="post" class="form-horizontal" onsubmit="return valid()" >
								<div class="well" style="padding-bottom: 20px; margin: 0;">
			                    	...
			                    	<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="title" name="title" class="validate[required,minSize[6],maxSize[120]] text-input span6" onkeyup="this.value=this.value.replace(/(^\s*)/g,'')" onblur="this.value=this.value.replace(/(\s*$)/g,'')"/>
										</div>
									</div>
									<!-- <div class="control-group">
									...
									<div class="control-group" id="pushType">
										...
										<div class="controls">
											<div class="row-fluid">
												<div class="span2">
													<input type="radio" name="pushType" value="0" checked="checked" class="validate[required] radio span4">
													<span>无</span>
												</div>
												<div class="span2">
									...
									<div class="control-group" id="product">
										...
										<div class="controls">
											<div class="row-fluid">
												<div class="span2">
										            <span id="productName" style="height:30px; line-height:30px"></span>
        ...
        <div class="modal hide fade" id="productList" role="dialog" >
		      		...
		      		<div class="modal-body">
		      			<div class="navbar-inner block-header modal-header">
	                   		<div id="productForm" class="input-group pull-left form-search">
	                         	...
	                         	<input type="submit" value="查询" onclick="search(1)" class="btn btn-default" />
	                       	</div>
                    	</div>
	...
	<script type="text/javascript">
		...
		$(function(){
			$('.breadcrumb').html('<li class="active">消息管理&nbsp;/&nbsp;<a href="javascript:quit();">APP推送管理</a>&nbsp;/&nbsp;新增推送</li>');
		...
		function valid() {
			...
			if($("input[name='pushType']:checked").val()==2) {
				if($('#newsId').val()<1){
					alert('请选择新闻素材');					
		            return false;
				}
