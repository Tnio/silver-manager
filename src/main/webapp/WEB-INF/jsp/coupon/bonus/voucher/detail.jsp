...
<html>
            ...
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
                    ...
                    <div class="row-fluid">
                        <!-- block -->
                        <div class="block">
                        	<form id="search" action="${pageContext.request.contextPath}/coupon/bonus/voucher/exchange/record/${couponId}" method="post">
	...
	<script type="text/javascript">
	    ...
	    var id = 0;
	    var status = 0;
	    $('.breadcrumb').html('<li class="active">券码管理&nbsp;/&nbsp;<a href="${pageContext.request.contextPath}/coupon/coupon/list">券码库</a>&nbsp;/&nbsp;红包兑换券兑换明细</li>');
			...
			if(totalPages > 0) {
				var options = {
		            ...
		            onPageClicked: function(event, originalEvent, type, page){
		            	$('#search').attr('action','${pageContext.request.contextPath}/coupon/bonus/voucher/exchange/record/${couponId}');
		            	$('#page').val(page);
		                $('#search').submit();
		            }  
			    };
