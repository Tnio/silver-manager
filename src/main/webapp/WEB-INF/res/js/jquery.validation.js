			...
			for (var i = 0, field_errors = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "dayLimitMin" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._dayLimitMin);
						break;
					case "monLimitMin" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._monLimitMin);
						break;
					case "max" :
						errorMsg = methods._getErrorMessage(form, field,
					...
					case "limitMax" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options, methods._limitMax);
						break;
					case "dayLimitMax" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._dayLimitMax);
						break;
					case "past" :
						errorMsg = methods._getErrorMessage(form, field,
					...
					case "passwordSp" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._password_validate);
						break;
					case "idcardEqu" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._idcard_validate);
						break;
					case "nameEqu" :
						errorMsg = methods._getErrorMessage(form, field,
								rules[i], rules, i, options,
								methods._name_validate);
						break;
					case "funcCall" :
						errorMsg = methods._getErrorMessage(form, field,
