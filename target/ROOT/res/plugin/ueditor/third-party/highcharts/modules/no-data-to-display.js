/*
 * Highcharts JS v3.0.6 (2013-10-04) Plugin for displaying a message when there
 * is no data visible in chart.
 * 
...
(function(c) {
	...
	e.showNoData = function(a) {
		...
		if (!this.noDataLabel)
			this.noDataLabel = this.renderer.label(a, 0, 0, null, null, null,
					null, null, "no-data").attr(b.attr).css(b.style).add(), this.noDataLabel
					.align(i(this.noDataLabel.getBBox(), b.position), !1,
							"plotBox")
	};
