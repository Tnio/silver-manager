...
var HighchartsAdapter = function() {
	function o(c) {
		...
		c.HCExtended || Highcharts.extend(c, {
			...
			unbind : function(c, h) {
				...
				c
						? (f = this.HCEvents[c] || [], h
								? (i = HighchartsAdapter.inArray(h, f), i > -1
										&& (f.splice(i, 1), this.HCEvents[c] = f), this.removeEventListener
										? a(this, c, h)
	...
	return {
		init : function(c) {
			if (!l.defaultView)
				this._getStyle = function(a, d) {
					var b;
					return a.style[d] ? a.style[d] : (d === "opacity"
							&& (d = "filter"), b = a.currentStyle[d.replace(
							/\-(\w)/g, function(a, b) {
					...
					if (b)
						return a.style.zoom = 1, a[b]
								- 2
								* parseInt(HighchartsAdapter._getStyle(a,
												"padding"), 10)
				};
			...
			n.prototype = {
				update : function() {
					...
					a && b
							? d.attr("d", c
											.step(a[0], a[1], this.now,
													this.toD))
							: d.attr
									? b && d.attr(this.prop, this.now)
									: (a = {}, a[d] = this.now + this.unit, Highcharts
											.css(d, a));
					this.options.step
							&& this.options.step
				...
				step : function(a) {
					...
					if (this.elem.stopAnimation)
						...
						e = c - this.startTime, this.state = e / b.duration, this.pos = b
								.easing(e, 0, 1, b.duration), this.now = this.start
								+ (this.end - this.start) * this.pos, this
								.update(), b = !0;
					return b
				}
			};
					...
					i = new n(a, b, g), f = null, g === "d"
							...
							: a.attr
									...
									: (e = parseFloat(HighchartsAdapter
											._getStyle(a, g))
											|| 0, g !== "opacity" && (h = "px")), f
							|| (f = parseFloat(d[g])), i.custom(e, f, h)
			}
		},
		...
		getScript : function(c, a) {
			var d = l.getElementsByTagName("head")[0], b = l
