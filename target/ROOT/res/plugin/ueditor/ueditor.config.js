...
(function() {
    ...
    var URL2 = window.UEDITOR_HOME_URL2 || getUEBasePath();
	...
	window.UEDITOR_CONFIG = {
		...
		// 服务器统一请求接口路径
		,
		serverUrl : URL2 + "jsp/controller.jsp"
		...
		, /*
			 ...
			 * 'drafts' ]]
			 */
		toolbars : [["source", "fullscreen", "undo", "redo", "link", "unlink",
				"preview", "simpleupload", "date", "time", "bold", "italic",
		...
		,
		wordCountMsg : '当前已输入 {#count} 个字符，您还可以输入{#leave} 个字符' // 当前已输入
																// {#count}
																// 个字符，您还可以输入{#leave}
																// 个字符
