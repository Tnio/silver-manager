...
_e(function (E, $) {
    ...
    Txt.fn.bindEnterForDiv = function () {
        var tags = E.config.legalTags; // 配置中编辑器要求的合法标签，如 p head table
										// blockquote ul ol 等
        var self = this;
        var editor = self.editor;
        var $txt = self.$txt;
    ...
    Txt.fn.bindHtml = function () {
        ...
        $txt.html = function (html) {
            ...
            if (html === undefined) {
                ...
                // 因为 .html() 或者 .innerHTML 会把所有的 & 字符都改成 &amp; 但是 src 和 href
				// 中的要保持 &
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
            selectorForELemCommand: 'font[face]'  // 为了执行
													// editor.commandForElem
													// 而传入的elem查询方式
        });
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
            selectorForELemCommand: 'font[size]'  // 为了执行
													// editor.commandForElem
													// 而传入的elem查询方式
        });
...
_e(function (E, $) {
    E.createMenu(function (check) {
        ...
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
            // 对 ol 直接设置 head，会出现每个 li 的 index 都变成 1 的问题，因此要先取消 ol，然后设置
			// head，最后再增加上 ol
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        var editor = this;
        var fns = editor.config.uploadImgFns; // editor.config.uploadImgFns =
												// {} 在config文件中定义了
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            var editor = this;
            var originalName = editor.uploadImgOriginalName || '';  // 上传图片时，已经将图片的名字存在
																	// editor.uploadImgOriginalName
            var img;
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $zoomSmall = $('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>');
        var $zoomBig = $('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>');
        // var $floatLeft = $('<a href="#"><i
		// class="wangeditor-menu-img-align-left"></i></a>');
        // var $noFloat = $('<a href="#"><i
		// class="wangeditor-menu-img-align-justify"></i></a>');
        // var $floatRight = $('<a href="#"><i
        ...
        function bindToolbarEvent() {
            ...
            $alignLeft.click(function (e) {
                commandFn = function () {
                    // 如果 img 增加了链接，那么 img.parent() 就是 a 标签，设置 align 没用的，因此必须找到
					// P 父节点来设置 align
