                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
	                            <form id="fm" onsubmit="return validate()" action="${pageContext.request.contextPath}/system/role/save" method="post" class="form-horizontal" >
									<input id="id" name="id" value="0" type="hidden">
									<div class="well" style="padding-bottom: 20px; margin: 0;">
				                    	<div class="control-group">
											<label class="control-label"><span class="required">*</span>角色名称</label>
											<div class="controls">
											    <input type="text" id="name" name="name" onkeyup="this.value=this.value.replace(/(^\s*)/g,'')" onblur="this.value=this.value.replace(/(\s*$)/g,'')" class="validate[required,maxSize[12],custom[anotherNotSpecialCharacter],ajax[ajaxValidateRoleName]] span8" />
