...
<html>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
                    ...
                    <div class="well">
                     	<form id="search" action="${pageContext.request.contextPath}/statistics/old/earning" method="post">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <table class="table">
                                       			...
                                       			<c:forEach var ="earning" items="${earnings}" varStatus="status">
                                       				<tr>
														<td>${earning.productName}</td>
                                       					...
                                       					<td><fmt:formatNumber value="${earning.companyEarning-earning.operatingCost-earning.paymentCost}" pattern="#,##0.00" /></td>
                                       				</tr>
                                       			</c:forEach>
                                       		</c:when>
                                       		<c:otherwise>
                                       			<tr>
                                       				<td colspan="6">暂时没有收入记录信息</td>
                                       			</tr>
                                       		</c:otherwise>
                                       	</c:choose>
                                       </tbody>
                                       <tfoot>
                                       	  <tr>
                                        	  <td colspan="6">运营费用:<fmt:formatNumber value="${totalOperatingCost}" pattern="#,##0.00" />元
	...
	<script type="text/javascript">
		$('.breadcrumb').html('<li class="active">统计管理&nbsp;/&nbsp;历史收入</li>');
