...
<html>
            ...
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
                    ...
                    <div class="well" style="height:40px">
                    	<form id="search" action="${pageContext.request.contextPath}/statistics/increase/${source}" method="post" >
                                ...
                                <div class="span12">
                                    <table id="increaseCoupon" cellpadding="0" cellspacing="0" border="0" class="table" >
                                        <thead>
                                            <tr>
                                            	<th>序号</th>
                                                <th class="center">加息率（%）</th>
                                                <th class="center">使用条件</th>
                                                <th class="center">加息天数</th>
                                        		...
                                        		<c:when test="${fn:length(increaseCoupons) > 0}">
                                        			<c:forEach var ="coupon" items="${increaseCoupons}" varStatus="status">
                                        				<tr>
                                        					<td>${status.count}</td>
                                        					<td>${coupon.amount}</td>
                                        					<td>${coupon.useCondition}</td>
                                        					<td>${coupon.financePeriod}</td>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.breadcrumb').html('<li class="active">统计管理&nbsp;/&nbsp;加息券统计明细</li>');
