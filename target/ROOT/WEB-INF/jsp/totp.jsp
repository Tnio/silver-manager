...
<html>
  ...
  <body background="${pageContext.request.contextPath}/images/backgroud.png" style="margin:0;background-size:cover; ">
   <form id="totp" action="${pageContext.request.contextPath}/totp" method="post" ><!-- onsubmit="return validate()" -->
    <input id="userName" name="userName" type="hidden" value="${userName}" />
    <input id="secretKey" name="secretKey" type="hidden" value="${secretKey}" />
    <input id="totpURL" name="totpURL" type="hidden" value="${totpURL}" />
	<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    ...
	    <table width="347" height="336" border="0" align="left" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/images/from_bg.png">
	      ...
	      <tr>
	        <td height="40">密钥：${secretKey}</td>
	      </tr>
	      <tr>
	      <tr>
	        <td height="40" colspan="2">
	        <div class="input-group">
	          <input id="authCodeFirst" name="authCodeFirst" type="text" class="validate[required,minSize[6],maxSize[6],custom[number]] form-control" placeholder="第一组银狐令" >
	        </div>
	        </td>
	      </tr>
	      <tr>
	        <td height="40" colspan="2">
	        <div class="input-group">
	          <input id="authCodeSecond" name="authCodeSecond" type="text" class="validate[required,minSize[6],maxSize[6],custom[number]] form-control" placeholder="第二组银狐令" >
	        </div>
	        </td>
	      </tr>
	      <tr>
