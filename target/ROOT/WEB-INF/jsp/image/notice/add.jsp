            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    ...
                    <div class="block-content collapse in">
                        <form class="form-horizontal" enctype="multipart/form-data" id="fm" method="post" onsubmit="return startValidate();" action="${pageContext.request.contextPath}/banner/notice/save">
                            <div class="well" style="padding-bottom: 20px; margin: 0;">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls" id="imageChoice" >
                                        ...
                                        <span  ><font class="msg"  >（APP弹窗图建议尺寸：575*755；WEB弹窗图建议尺寸：745*710，png或者jpg格式）</font></span>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $('.breadcrumb').html('<li class="active">图片管理&nbsp;/&nbsp;<a href="javascript:quit();">弹窗公告管理&nbsp;</a>/&nbsp;新增</li>');
