...
<html>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span10" id="content">
                    ...
                    <input id="source" name="source" value="${rule.source}" type="hidden">
                    ...
                    <input id="couponBirthdayList" name="couponBirthdayList" type="hidden" value="${couponLists}">
					      ...
					      <div class="accordion-inner">
					      	<div class="well" style="margin: 0;">
					      		...
					      		<c:if test="${rule.source != 10}">
					      			...
					      			<div id="birthdayDate" class="row-fluid">
						      			<div class="span6">
											<div class="control-group">
												<label class="control-label"><span class="required">*</span>赠送日期</label>
												<div class="controls">
													<input type="text" value="生日当天赠送" class="text-input span6" readonly />
												</div>
											</div>
						      			</div>
						      		</div>
						      		<div id="vipcoupon" class="row-fluid">
						      			<div class="span6">
											<div class="control-group">
												<label class="control-label"><span class="required">*</span>赠送方式</label>
												<div class="controls">
													<input type="text" value="用户主动领取" class="text-input span6" readonly />
												</div>
											</div>
						      			</div>
						      		</div>
						      		
						      		<div id="vipbirthday" class="row-fluid">
						      		   <div class="span10">
											<div id="choiceredbacket" style = position:absolute;top:55% ; left:12% ;  ><label class="control-label"><span class="required">*</span>选择红包</label></div>
											<div class="control-group">
											
											<table class="table table-striped" id="vipTable" >
											       <tr>
											           <td rowspan="8" ><label class="control-label"></label></td>
											           <td class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon1"  value="">
									                   <input type="hidden" id="vipId1"  value="">
											           VIP1 &nbsp &nbsp &nbsp<input id ="VIP1" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(1,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip1" value="">
											           VIP1 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(1,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(1,4)"/>
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip1" value="0"> 
											              <div class="controls" id="paybackRuleGroup1"></div> 
											           </td>
											      </tr>
											      ...
											      <tr> 
											           <td  class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon2"  value="">
									                   <input type="hidden" id="vipId2"  value="">
											             VIP2 &nbsp &nbsp &nbsp<input id ="VIP2" value="" type="text" class="text-input span4" id=""  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(2,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip2" value="">
											             VIP2 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(2,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(2,4)"/>
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip2" value="0"> 
											              <div class="controls" id="paybackRuleGroup2"></div> 
											           </td>
											      </tr>
											      <tr>
											           <td class="span4">
											           <c:if test="${rule.source == 8 }">
									                   <input type="hidden" id="vipCouopon3"  value="">
									                   <input type="hidden" id="vipId3"  value="">
											             VIP3 &nbsp &nbsp &nbsp<input id ="VIP3" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(3,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip3" value="">
											            VIP3 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(3,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(3,4)"/>
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip3" value="0"> 
											              <div class="controls" id="paybackRuleGroup3">
												         </div> 
												       </td>
											      </tr>
											      <tr>
											           <td class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon4"  value="">
									                   <input type="hidden" id="vipId4"  value="">
											           VIP4 &nbsp &nbsp &nbsp<input id ="VIP4" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(4,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip4" value="">
											           VIP4 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(4,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(4,4)"/>
											           
											           </c:if>
											           </td> 
											           <td class="span8">
											              <input type="hidden" id="couponnumvip4" value="0"> 
											              <div class="controls" id="paybackRuleGroup4"></div> 											           
											           </td>
											      </tr>
											      <tr>
											           <td class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon5"  value="">
									                   <input type="hidden" id="vipId5"  value="">
											           VIP5 &nbsp &nbsp &nbsp<input id ="VIP5" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(5,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip5" value="">
											           VIP5 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(5,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(5,4)"/>
											           
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip5" value="0"> 
											              <div class="controls" id="paybackRuleGroup5"></div> 
											           </td>
											      </tr>
											      <tr>
											           <td class="span4"> 
											           <c:if test="${rule.source == 8 }">
									                   <input type="hidden" id="vipCouopon6"  value="">
									                   <input type="hidden" id="vipId6"  value="">
											           VIP6 &nbsp &nbsp &nbsp<input id ="VIP6" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(6,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14 }">
											           <input type="hidden" id="coponIdsVip6" value="">
											           VIP6 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(6,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(6,4)"/>
											           
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip6" value="0"> 
											              <div class="controls" id="paybackRuleGroup6"></div> 
											           </td>
											      </tr>
											      <tr> 
											           <td class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon7"  value="">
									                   <input type="hidden" id="vipId7"  value="">
											           VIP7 &nbsp &nbsp &nbsp<input id ="VIP7" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(7,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip7" value="">
											           VIP7 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(7,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(7,4)"/>
											           
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip7" value="0"> 
											              <div class="controls" id="paybackRuleGroup7"></div> 
											           </td>
											      </tr>
											      <tr>
											           <td class="span4">
											           <c:if test="${rule.source == 8}">
									                   <input type="hidden" id="vipCouopon8"  value="">
									                   <input type="hidden" id="vipId8"  value="">
											           VIP8 &nbsp &nbsp &nbsp<input id ="VIP8" value="" type="text" class="text-input span4"  placeholder="请选择一个红包" readonly onclick="showVipBonusDialog(8,0)"/>
											           </c:if>
											           <c:if test="${rule.source == 14}">
											           <input type="hidden" id="coponIdsVip8" value="">
											           VIP8 &nbsp &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择红包" readonly onclick="showVipBonusDialog(8,0)"/>
											                          &nbsp &nbsp<input type="text" class="text-input span4"  placeholder="选择加息券" readonly onclick="showVipBonusDialog(8,4)"/>
											           </c:if>
											           </td>
											           <td class="span8">
											              <input type="hidden" id="couponnumvip8" value="0"> 
											              <div class="controls" id="paybackRuleGroup8"></div> 
											           </td>
											      </tr>
											</table>
						      		...
						      		<div class="row-fluid" id="showcoupons">
						      			<div class="span10">
											<div class="control-group" >
		                                           		...
		                                           		<c:forEach var="couponId" items="${fn:split(rule.couponIds,',')}" varStatus="status">
															<c:forEach var="couponAmount" items="${fn:split(rule.couponAmounts,',')}" varStatus="statuss">
																<c:if test="${status.index == statuss.index}">
																	<a <c:if test="${operation == 'edit'}"> href="javascript:remove(div${status.count})"</c:if>
																	   <c:if test="${operation == 'detail'}"> href="javascript:showDialog(${couponId})"</c:if>
																	    id="div${status.count}">
	...
	<script type="text/javascript">
		...
		function choiceBonus(couponId, financePeriod, amount, condition, category, ruleNum){
			...
			if (ruleNum >= 0) {
				if("${rule.source}" == 8){
				var couponid = $("#vipCouopon" +ruleNum).val();
				if(couponid > 0){
					alert("您一次不能添加更多的优惠券了!");
					return;
				   }
				...
				if("${rule.source}" == 14){
					var couponids= $('#coponIdsVip'+ruleNum).val();
					if(couponids){
						var conponInfos = couponids.split(',');
						if (conponInfos && conponInfos.length >= 10) {
							alert('您一次不能添加更多的优惠券了!');
							return ;
					    }
				     }
			...
			if (ruleNum >= 0) {
				if("${rule.source}" ==14){
					if ($('#coponIdsVip'+ruleNum).val()) {
						$('#coponIdsVip'+ruleNum).val($('#coponIdsVip'+ruleNum).val()+','+couponId);
					} else {
						$('#coponIdsVip'+ruleNum).val(couponId);
					}	
				}
				...
				var type='${operation}';
				if(type=='edit'){	
				$('#paybackRuleGroup'+ruleNum).append('<a href="javascript:remove(div'+ruleNum+vipindex+', '+ruleNum+', '+couponId+', '+"'"+amount+company+"'"+')" id="div'+ruleNum+vipindex+'" amount="'+amount+'"><input id="couponIds'+ruleNum+vipindex+'" name="couponIds"  value="'+couponId+'" type="hidden" ><input id="couponAmount'+ruleNum+vipindex+'" name="couponAmounts"  value="'+amount+company+'" type="hidden" ><input id="coupons'+ruleNum+vipindex+'" name="coupons"  value="'+couponId+'*'+amount+company+'" type="hidden" ><span class="label label-important" style="height:22px;width:75px;margin-top: 1px;margin-left: 5px;padding-top: 8px" title="点击可删除">'+ amount + company +' </span></span></a>');
				}else{
				$('#paybackRuleGroup'+ruleNum).append('<a href="javascript:showDialog('+couponId+')" id="div'+ruleNum+index+'" amount="'+amount+'"><input id="couponIds'+ruleNum+index+'" name="couponIds"  value="'+couponId+'" type="hidden" ><input id="couponAmount'+ruleNum+index+'" name="couponAmounts"  value="'+amount+company+'" type="hidden" ><input id="coupons'+ruleNum+index+'" name="coupons"  value="'+couponId+'*'+amount+company+'" type="hidden" ><span class="label label-important" style="height:22px;width:75px;margin-top: 1px;margin-left: 5px;padding-top: 8px" title="点击可删除">'+ amount + company +' </span></span></a>');
				}
				$('#VIP'+ruleNum).val(amount+company);
				$('#vipCouopon'+ruleNum).val(couponId);
			} else {
			...
			if (ruleNum >= 0) {
				...
				if("${rule.source}" == 14){
					...
					if (couponids) {
						...
						$('#coponIdsVip'+ruleNum).val(couponids);
					}
				}else {
				var couponIds = $('#ruleCouponIds'+ruleNum).val();
		...
		function addRule() {
			...
			html += '<span>元，奖励红包</span>';
			html += '<input type="text"  style="width: 120px;" onclick="showBonusDialog(0, '
					+ ruleNum + ')" readonly class="text-input"/>';
			html += '<span>奖励加息券</span>';
			html += '<input type="text"  style="width: 120px;" onclick="showBonusDialog(4, '
					+ ruleNum + ')" readonly class="text-input"/>';
			if (ruleNum > 0) {
				html += '<input type="button" class="btn btn-lg" value="删除" onclick="delHtml('
						+ ruleNum + ')">';
			}
		...
		function getCoupon(couponId) {
			$('#head').html("");
			$.get('${pageContext.request.contextPath}/coupon/coupon/detail', {
				couponId : couponId
			},
					function(result) {
						if (result != null) {
							...
							if (result.category < 4) {
								...
								if (result.moneyLimit == 1) {
									$('#couponBody').append(
											'<td>单笔满' + result.tradeAmount
													+ '元可用 </td>');
								}
								if (result.moneyLimit == 2) {
									$('#couponBody').append(
											'<td>累计满' + result.tradeAmount
													+ '元可用 </td>');
								}
								$('#couponBody').append('</tr>');
								$('#couponBody').append('<tr>');
							...
							$('#couponBody').html(
									'<tr><td colspan="2">请先添加优惠券</td></tr>');
						}
					});
		}
		function showVipBonusDialog(index, type) {
			viplevelnum = index;
			showBonusDialog(type);

		}
		function saveVipBirthdayCoupons(source) {
			...
			if (source == 8) {
				...
				for (var i = 1; i <= 8; i++) {
					...
					JsonData.vipLevel = i;
					JsonData.id = $("#vipId" + i).val();
					var text = $("#vipCouopon" + i).val();
					if (text == null || text == undefined || text == "") {
						JsonData.couponId = 0;
					} else {
						JsonData.couponId = parseInt(text);
					}

					aa.push(JsonData);
				}
				couponVips = JSON.stringify(aa);
				$.ajax({
					type : 'post',
					async : false,
					url : '${pageContext.request.contextPath}/coupon/bonus/vip/birthday/save',
					data : couponVips,
				...
				for (var i = 1; i <= 8; i++) {
					var JsonData = new Object();
					JsonData.vipLevel = i;
					var text = $("#coponIdsVip" + i).val();
					if (text == null || text == undefined || text == "") {
						JsonData.couponId = "0";
					} else {
						JsonData.couponId = text;
					}
					aa.push(JsonData);
				}
				couponVips = JSON.stringify(aa);
				$.ajax({
					type : 'post',
					async : false,
					url : '${pageContext.request.contextPath}/coupon/bonus/vip/save',
					data : couponVips,
					success : function(data) {
					}
				});
		...
		$(function() {
			if("${rule.source}" == 8 || "${rule.source}" == 14){
			couponList = eval('${couponLists}');
			var couponId = 0;
			var financePeriod = 0;
			var amount = "";
			var condition = "";
			...
			for (var i = 0; i < couponList.length; i++) {
				$('#vipId' + couponList[i].vipLevel).val(couponList[i].id)
				b = couponList[i].coupon;
				if (b != null) {
					couponId = b.id;
					financePeriod = b.increaseDays;
					amount = b.amount;
					condition = b.name;
					category = b.category;
					ruleNum = couponList[i].vipLevel;
					choiceBonus(couponId, financePeriod, amount, condition,
							category, ruleNum);
				}
			}
			}
